...
uint256 hashGenesisBlock("0x9d73aa6207b41160fe8fe7bc744fbfeb240603413e4f6d628264ed509ab709c2");
...
const string strMessageMagic = "Hucoin Signed Message:\n";
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    if(nHeight < 100) // Instamine, spielgeld in first blocks
        nSubsidy = 500 * COIN;
...
static const int64 nTargetTimespan = 0.35 * 24 * 60 * 60; // Hucoin: 0.35 days
static const int64 nTargetSpacing = 60; // Hucoin: 60 seconds
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal hucoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Hucoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x51fe14fecda7b8f193344d28c42ca146806b3dd8460cc23346ec53eeb32d34ea");
    }
	...
	// vMerkleTree: 5a2e19825b
        ...
        // Genesis block
        const char* pszTimestamp = "Shrimps und Fisch sind leckere Dinge";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1528120849;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 217797006;

        if (fTestNet)
        {
            block.nTime    = 1528120849;
            block.nNonce   = 2177970;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xb207bf8dfb02cedf29e28a1ee75df2d0219d82c547fca7b6f0eea3db1205188b"));
